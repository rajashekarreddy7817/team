...
public class CaptureSow extends TestBase{
	By structureStatusSectionDropDown=By.className("//*[contains(text(),' Structure Status Section ')]");
	By lat_Long_GEUpdate= By.className("mat-expansion-indicator ng-tns-c191-257 ng-trigger ng-trigger-indicatorRotate ng-star-inserted");
	By selectLat_Long_GEUpdateYes= By.xpath("(//div[@class='mat-ripple mat-option-ripple'])[1]");
